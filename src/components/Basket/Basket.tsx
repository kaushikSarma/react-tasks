    ...
    render () {
        ...
        return (<div className='basket'>
            {!this.state.isExpanded && <div className='mini-basket'>
                {this.props.nextOffer !== undefined && this.props.nextOffer.offer_title !== "" && totalprice > 0 && <span className='dynamic-offer'>{`Add ₹${this.props.nextOffer.basket_difference} to get ${this.props.nextOffer.offer_title}`}</span>}
